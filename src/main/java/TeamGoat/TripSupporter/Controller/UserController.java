...
@RequestMapping("/user")
@Validated // Controller, Service, Repository, Validator, Converter, and ProceedingJoinPoint에 @Valid, @NotNull, @Min, @Max, @Pattern, @Size, @Email, @Past, @Future, @PastOrPresent, @NotNullOrEmpty, @Positive, @PositiveOrZero, @Negative, @NegativeOrZero, @DecimalMin, @DecimalMax, @Digits, @FutureOrPresent, @NotNullOrBlank, @Size(min =)
